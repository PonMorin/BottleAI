...
"background-color: rgb(57, 125, 84);")
        ...
        self.label_4.setFont(font)
        self.label_4.setObjectName("label_4")
        self.point = QtWidgets.QLabel(self.centralwidget)
        self.point.setGeometry(QtCore.QRect(40, 100, 431, 50))
        font = QtGui.QFont()
        font.setFamily("Berlin Sans FB Demi")
        font.setPointSize(18)
        font.setBold(True)
        ...
        self.point.setStyleSheet("background-color: rgb(153, 184, 152);")
